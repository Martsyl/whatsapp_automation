...
urlpatterns = [
    ...
    path('payment/renew-verify/', views.renew_verify,   name='renew_verify'),
    path('profile/ai-description/', views.update_ai_description, name='update_ai_description'),
    ...
    path('payment/receipt/<str:reference>/view/',     views.view_receipt,     name='view_receipt'),
    path('payment/receipt/<str:reference>/download/', views.download_receipt, name='download_receipt'),
]